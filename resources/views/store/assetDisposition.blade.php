        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcome-list shadow-reset">
                    <div class="row">
                        <div class="col-lg-6">
                            <button class="btn btn-custon-rounded-three btn-success" data-toggle="modal" data-target="#InformationproModalalert"><i class="fa fa-plus"></i> Dispose Asset</button>
                                    ...
                                    <div class="basic-login-inner">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" placeholder="Enter Asset Code" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">

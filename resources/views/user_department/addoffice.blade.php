                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Add Office</a> <span class="bread-slash"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Add Office</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Add Office  <span class="table-project-n"></span> Form</h1>
                            ...
                            <div class="sparkline9-list shadow-reset">
                                <div class="sparkline9-hd">
                                    <div class="main-sparkline9-hd">
                                        <h1>Add Office<span class="basic-ds-n"></span></h1>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="basic-login-inner">
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <label class="login2">Office no : </label>
                                                            </div>
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" placeholder="Enter Office no" style="width: 100%" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <label class="login2">Office name : </label>
                                                            </div>
                                                            <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <label class="login2">Use : </label>
                                                            </div>
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" placeholder="usage" style="width: 100%" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" placeholder="Enter witheld capacity" style="width: 100%" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <label class="login2">Main Officer : </label>
                                                                </div>
                                                                <div class="col-lg-8">
                                                                    <input type="text" class="form-control" placeholder="Enter Employee name" style="width: 100%" />
                                                                </div>

                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                <div class="income-title">
                                    <div class="main-income-head">
                                        ...
                                        <br>
                                            <button type="button" class="btn btn-primary btn-circle">View<i class="fa fa-link"></i>
                                    </div>
                                </div>
                                ...
                                <div class="income-title">
                                    <div class="main-income-head">
                                        ...
                                        <div class="main-income-phara order-cl">
                                            <button type="button" class="btn btn-primary btn-circle">View<i class="fa fa-list"></i>
                                            </div>
                                    </div>
                                </div>
                                <div class="income-dashone-pro">
                            ...
                            <div class="income-dashone-total user-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range low-value-cl">
                                        ...
                                        <span class="income-percentange">86% <i class="fa fa-file-archive-o"></i></span>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="income-dashone-total user-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range low-value-cl">
                                        <p>Total Electronical Assets</p>
                                        <span class="income-percentange">59% <i class="fa fa-file-archive-o"></i></span>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
